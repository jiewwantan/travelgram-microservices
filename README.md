# Travelgram Travel Bucket List App
...
The projecrt source code is available at the Github repository: 
https://github.com/jiewwantan/travelgram-microservices
...
### Backend API
* To download all the package dependencies, run the command from the directory `travelgram-api/`:
    ```bash
    npm install .
    ```
...
### Frontend App
* To download all the package dependencies, run the command from the directory `travelgram-frontend/`:
    ```bash
    npm install .
    ```
